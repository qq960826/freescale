...
long speed_error; //理想与实际速度偏差值
long pre_error; //速度PID 前一次的速度误差值ideal_speed- pulse_count
long pre_d_error; //速度PID 前一次的速度误差之差d_error-pre_d_error?
long ideal_speed=10;
long pk=0;
...
void motor_right_pid(){
  ...
  error = ideal_speed - omron_encoder_left_now;
